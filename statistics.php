...
<html lang="en">
    ...
    <body>
        <div class="container-fluid">
                    ...
                    <div class="navbar-collapse collapse w-100 order-1 order-md-0 dual-collapse2">
                        <ul class="navbar-nav mr-auto">
                            <li class="nav-item selected-nav-item">
                                <a class="nav-link activated-link" href="statistics.php">Statistics</a>
                            </li>
                            <li class="nav-item">
            ...
            <div class="row">
                <div class="col-6">
                    <div class="display-4 canvas-heading">Individual Expenses</div>
                    <canvas id="mycanvas1" class="graph-canvas"></canvas>
                </div>
                <div class="col-6">
                    <div class="display-4 canvas-heading">Productwise Expenses</div>
                    <canvas id="mycanvas2" class="graph-canvas"></canvas>
                </div>
            </div>
        </div>
